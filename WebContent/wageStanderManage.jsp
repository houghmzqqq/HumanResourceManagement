...
<html>
  <head>
	 ...
	 {
		if(i==1)
	 		window.navigate("wageStanderRegisterServlet");
	 	if(i==2)
	 		window.navigate("wageStanderReviewServlet");
	 	if(i==3)
	 		window.navigate("wage_search.jsp");
	 	if(i==4)
  ...
  <body>
	 <div>
	 	<button onclick="change(1)">薪酬标准登记</button><br/>
	 	<button onclick="change(2)">薪酬标准复核</button><br/>
	 	<button onclick="change(3)">薪酬标准查询</button><br/>
