...
<html>
  ...
  <body>
	 <div id="rightDiv">
		...
		<form action="${pageContext.request.contextPath}/SystemSetTorgaServlet" method="post">
			<table>
				<tr>
					<td id="f_td">一级机构名</td>
				...
				<tr>
					<td id="f_td">二级机构名</td>
					<td><select id="sOrganizationName" name="sOrgaName">
						<option>请选择</option>
					</select></td>
				</tr>
				<tr>
					<td id="f_td">三级机构名称</td>
					<td><input name="tOrganizationName" /></td>
				</tr>
			</table>
