...
public class RecordReviewJDBC 
{
	...
	public Vector<RecordBean> getRecordList()
	{
	...
	public RecordBean getRecord(String recordId)
	{
		...
		try
		{
			...
			state = conn.createStatement();
			//3.查询该一级机构下的二级机构名称
			rs = state.executeQuery("select * from staffRecord where recordId='"+recordId+"'");
